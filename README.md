...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 622e7ad9-1ba6-4270-a2be-1eac363854df
```

> `622e7ad9-1ba6-4270-a2be-1eac363854df` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the `TodoApp` directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disabled it.
